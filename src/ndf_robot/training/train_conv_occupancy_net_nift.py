...
if __name__ == '__main__':
    ...
    # -- CREATE DATALOADERS -- #
    train_dataset = dataio.JointSCFTrainDataset(**train_dataloader_args)
    val_dataset = dataio.JointSCFTrainDataset(**val_dataloader_args)
    ...
    loss_fn = val_loss_fn = losses.contrastive_cross_entropy_nift(**loss_fn_args)
